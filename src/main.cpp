  ...
  while(running)
  {
    if (kbhit())
    {
      ...
      switch (key)
      {
        ...
        MODE('4', "Joint_Space_PD")
        MODE('5', "Task_Space_PD_init")
        MODE('6', "Task_Space_PD")
        MODE('7', "VelocitySaturation_init")
        MODE('8', "VelocitySaturation")

        // MODE('1', "simple_jacobian")
        // MODE('2', "feedback_jacobian")
        // MODE('3', "joint_ctrl_init")
        // MODE('4', "CLIK")
        // MODE('5', "Dynamics")
        // MODE('6', "NullSpace")
        // MODE('7', "VelocitySaturation")
      default:
        break;
      }
